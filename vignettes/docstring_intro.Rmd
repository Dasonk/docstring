...
documentation I would suggest reading the [Generating Rd files](https://cran.r-project.org/web/packages/roxygen2/vignettes/rd.html) vignette
...
mypaste <- function(x, y = "!"){
  ...
  #' }
  #' 
  #' @reference Tufte, E. R. (2001). The visual display of 
